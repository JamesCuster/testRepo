...
syntax for comments. You can {++ include ++} edits and they will be converted to
{-- tacked --}{++ tracked ++} changes in your {==  Word document
 ==}{>> Neat! <<}. By default {-- default --}, your system username is used as
the author of changes, but this can be set with the `comment_author` argument in
`redoc()` or your document YAML.
...
So what happens when I make changes in word without using tracked
changes?[]{.paragraph-insertion author="Custer, James"
date="2019-06-21T10:29:00Z"}

[]{.paragraph-insertion author="Custer, James" date="2019-06-21T10:29:00Z"}

{++ And what about what happens when I have track changes on? ++}
